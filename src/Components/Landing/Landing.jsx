...
export default function Landing() {
    return (
        <div className=' lg:pr-[108px] lg:pl-[108px] lg:mt-20 sm:mt-16 h-[480.9px]  flex sm:flex-col-reverse lg:flex-row lg:justify-between  sm:justify-center sm:items-center '>
            <div className=' lg:mt-3 sm:mt-7 lg:w-[50%] lg:h-[280px] sm:w-[328px] sm:h-[144px] flex flex-col items-center'>
                ...
                <div className='flex w-full justify-center lg:gap-x-10 sm:gap-x-4 lg:mt-12 sm:mt-6 lg:h-14 sm:h-8 '>
                    <Link href="/categories/new-carpet" className='btn lg:h-14 sm:h-10 lg:w-[206px] sm:w-[152px] lg:text-[18px] sm:text-[14px]'>محصولات ویژه ایرانی فرش</Link>
            ...
            <div className='lg:w-[40%] flex justify-center'>
                <Image width={530} height={470} className='lg:w-[527px] lg:h-[470px] sm:w-[280px] sm:h-[250px]' src="/images/Group3.png" alt='carpets' />
            </div>
        </div>
    )
}
