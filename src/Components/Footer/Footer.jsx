...
export default function Footer() {
    return (
        <footer className='flex lg:flex-row sm:flex-col-reverse gap-10 justify-between items-center bg-neutral-100 lg:mt-30 sm:mt-50 lg:pr-[108px] lg:pl-[108px] rounded-t-[50px]'>
            {/* ===================== right section =================== */}
            <div className='lg:w-[494px] flex flex-col justify-evenly lg:gap-y-7.5 sm:gap-y-5 lg:p-0 sm:pr-7 sm:pl-5'>
                ...
                <div className='flex justify-center items-center gap-x-1 lg:hidden sm:flex'>
                    <Image width={40} height={40} src="/images/Neofy-icon.png" className='mix-blend-darken' alt='Neofy' />
                    <h4 className='text-[10px] font-[Rokh-light] font-bold'>تمامی حقوق این سایت برای تیم برنامه نویسی <span className='text-primary'>نئوفای</span> میباشد</h4>
                </div>
            </div>
            {/* ===================== left section =================== */}
            <div className='lg:w-[50%] flex flex-col gap-y-10 sm:w-full font-[Rokh-light] font-bold p-7'>
                ...
                <div className='flex justify-center items-center gap-x-2 lg:flex sm:hidden'>
                    <Image width={40} height={40} src="/images/Neofy-icon.png" className='mix-blend-darken' alt='Neofy' />
                    <h4>تمامی حقوق این سایت برای تیم برنامه نویسی <span className='text-primary'>نئوفای</span> میباشد</h4>
                </div>
            </div>
        </footer>
    )
