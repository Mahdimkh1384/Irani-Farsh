...
export default function CustomerClub() {
    return (
        <div className='flex lg:flex-row sm:flex-col-reverse justify-between items-center lg:pr-[200px] lg:pl-[200px] sm:pr-3 sm:pl-3 lg:mt-25 sm:mt-14'>
            <div className='lg:w-[45%] lg:h-[330px] sm:w-[328px] sm:h-[226px] lg:mt-0 sm:mt-10 text-center flex flex-col justify-between items-center'>
                ...
                <Link href="/customer-club" className='btn w-[70%] h-14 lg:p-0 sm:p-2 lg:mt-0 sm:mt-8'>ایجاد عضویت</Link>
            </div>
            <div>
